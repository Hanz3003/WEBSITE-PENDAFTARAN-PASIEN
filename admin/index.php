            ...
            <table class="menu-container" border="0">
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">admin@e-Klinik.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">Janji Check-Up</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="doctors.php" method="post" class="header-search">
                                    ...
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Cari nama Dokter atau Email" list="doctors">&nbsp;&nbsp;
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    ...
                                    Janji Check-Up Mendatang sampai hari <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                    <p style="padding-bottom:19px;padding-left:50px;font-size:15px;font-weight:500;color:#212529e3;line-height: 20px;">
                                    Bagian Inilah untuk akses Cepat ke Janji 7 hari kedepan<br>
                                    Detail lebih lanjut tersedia di bagian @Janji Check-up.
                                    </p>
                                ...
                                <td>
                                    ...
                                    Bagian Inilah untuk akses Cepat ke Sesi 7 hari kedepan<br>
                                    Detail lebih lanjut tersedia di bagian @Jadwal.
                                    </p>
                                </td>
                            </tr>
                            <tr>
